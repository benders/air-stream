...
def load_config(config_path):
    ...
    try:
        ...
        if 'api_key' not in config or 'sensor_id' not in config:
            logger.error("Configuration file missing required fields: api_key, sensor_id")
            sys.exit(1)
...
def fetch_sensor_data(api_key, sensor_id):
    ...
    params = {
        "fields": "name,latitude,longitude,altitude,humidity,temperature,pressure,last_seen,pm2.5_a,pm2.5_10minute_a,pm2.5_30minute_a,pm2.5_60minute_a,confidence"
    }
